...
import { getAllNews } from '../services/adminService.js'
...
export default function AdminNews() {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    setError('')
    getAllNews({ status: status || undefined, search: q || undefined })
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="font-display text-3xl font-bold text-slate-900">All news</h1>
      ...
      <div className="mt-4 max-w-md">
        <SearchBar value={q} onChange={setSearch} placeholder="Search by title or summary..." />
      </div>
