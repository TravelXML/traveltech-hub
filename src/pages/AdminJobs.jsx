...
import { getAllJobs } from '../services/adminService.js'
...
export default function AdminJobs() {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    setError('')
    getAllJobs({ status: status || undefined, search: q || undefined })
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="font-display text-3xl font-bold text-slate-900">All jobs</h1>
      ...
      <div className="mt-4 max-w-md">
        <SearchBar value={q} onChange={setSearch} placeholder="Search by title or description..." />
      </div>
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-slate-500">
                    {item.listing?.name} · {item.category}
                  </p>
                </div>
                <span
