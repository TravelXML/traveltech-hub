...
import { getMyEvents, resubmitEvent } from '../services/eventService.js'
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <h1 className="font-display text-3xl font-bold text-slate-900">My events</h1>
        <Link
          to="/add-event"
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    <h2 className="font-display text-lg font-semibold text-slate-900">{item.name}</h2>
                    <span
                ...
                <div className="flex shrink-0 flex-wrap gap-2">
                  {EDITABLE_STATUSES.includes(item.status) && (
                    <Link
                      to={`/dashboard/events/${item.id}/edit`}
